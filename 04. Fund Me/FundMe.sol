...
// }
contract FundMe {
    uint private constant MINIMUM_USD_VALUE = 5e18; // we use 5e18 instead of 5 because the msg.value is calculated in wei so EVEN IF my ethInUSD returns in ETH, the msg.value is in WEI so I need to add 1e18 to 5
